...
import { useCreateTeamTrackerPayment } from '../../lib/queries/team'
import { fmtPlain } from '../../lib/calc/format'
...
export function TeamTrackerPaymentForm({
  teamTrackerId,
  due,
  onClose,
}: {
  teamTrackerId: string
  due: number
  onClose: () => void
}) {
